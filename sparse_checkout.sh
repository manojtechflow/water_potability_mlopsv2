...
git_folder_location='E:\Manoj_techflow\Water_potability_Mlopsv2'
project_name=water_potability_mlopsv2   #replace with your project name
github_org_name=manojtechflow   #replace with your github org name
project_template_github_url=https://github.com/manojtechflow/mlops-v2  #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
